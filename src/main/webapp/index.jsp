...
<body>
	...
	<div class="content2">
		...
		<div class='content2_box'>
			...
			<span class="button-text">인기매물 보기</span>
			</button></a><br> 
			<a href=""><button class="content-button">
	...
	<div class="content3">
		<div class='content3_box'>
			...
			<br><a href=""><button
					...
					<span class="button-text">동네 게시판 보기</span>
				</button></a>
		</div>
	...
	<div class='footer'>
		<div class='footer-content'>
			<ul class='footer-ul'>
				<li class='footer-li'><a class='footer-link'href="">중고거래</a></li>
				<li class='footer-li'><a class='footer-link'href="">인기거래</a></li>
				<li class='footer-li'><a class='footer-link'href="">동네 이야기</a></li>
				<li class='footer-li'><a class='footer-link'href="">공지사항</a></li>
				<li class='footer-li'><a class='footer-link'href="">마이페이지</a></li>
			</ul>
		</div>
		<div class='capyright'>
